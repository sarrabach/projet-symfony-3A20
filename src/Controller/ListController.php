    ...
    public function list(): Response
    {
        $formations = array(
            ...
            return $this->render('list/index.html.twig', [
                'controller_name' => 'ListController','formations' => $formations,
            ]);
    }
    
    #[Route('/list/{ref}', name: 'list_detail')]
        public function detail($ref): Response
        {
            $formations = array(
                array('ref' => 'form147', 'Titre' => 'Formation Symfony
                4','Description'=>'formation pratique',
            ...
            return $this->render('list/detail.html.twig', [
                'controller_name' => 'ListController','formations' => $formations,'ref' => $ref,
            ]);
        }
